...
def design():
    ...
    main_window.btn_0.setStyleSheet(''' QPushButton {font: 700 italic 14pt "Segoe UI";
                                    background-color: rgb(85, 255, 255);
                                    color: rgb(255, 0, 127);}
                                    QPushButton:hover:!pressed {background-color:rgb(0, 255, 0);}
                                    ''')
    main_window.btn_1.setStyleSheet('''QPushButton:hover {background-color:rgb(0, 255, 0);}
                                    QPushButton {font: 700 italic 14pt "Segoe UI";
                                    background-color: rgb(85, 255, 255);
                                    color: rgb(255, 0, 127);}''')
    ...
    main_window.btn_sub.setStyleSheet('''QPushButton:hover {background-color:rgb(153, 51, 255);}
                                     QPushButton {font: 10000 italic 14pt "Segoe UI";
                                    background-color: rgb(102, 0, 102);
                                    color: rgb(50, 255, 255);}''')
    # sum button
    main_window.btn_sum.setStyleSheet('''QPushButton:hover {background-color:rgb(153, 51, 255);}
                                     QPushButton {font: 900 italic 14pt "Segoe UI";
                                    background-color: rgb(102, 0, 102);
                                    color: rgb(50, 255, 255);}''')
    # multiplication button
    main_window.btn_mul.setStyleSheet(''' QPushButton {font: 700 italic 14pt "Segoe UI";
                                    background-color: rgb(102, 0, 102);
                                    color: rgb(50, 255, 255);}
                                    QPushButton:hover {background-color:rgb(153, 51, 255);}''')
    # division button
